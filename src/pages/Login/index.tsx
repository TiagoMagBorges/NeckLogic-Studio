    ...
    <div className="relative min-h-screen flex items-center justify-center bg-background px-6">
      ...
      <div className="w-full max-w-[400px]">
        ...
        <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="relative flex items-center">
              ...
              <input
                ...
                disabled={isSubmitting}
                required
                className="w-full bg-input-background border border-border/10 rounded-xl pl-12 pr-12 py-4 text-foreground text-[15px] focus:outline-none focus:border-primary"
              />
              <button
                type="button"
          ...
          >
            {isSubmitting ? <span className="auth-spinner" /> : t('login.submit')}
          </button>
        </form>
